...
import base64
from image_pdf import create_image_resume
from image_pdf_template2 import create_two_column_resume
...
def generate_resume_pdf():
    try:
        ...
        # Use different PDF template based on the template type
        if template_type == '1':
            # For resume_1: use the single-column layout with icons
            pdf_buffer = create_image_resume(data)
        else:
            # For resume_2: use the two-column layout
            pdf_buffer = create_two_column_resume(data)
